...
function AISandboxPage() {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      content: '¡Bienvenido! Puedo ayudarte a generar código con contexto completo de tus archivos y estructura. ¡Solo comienza a escribir - crearé automáticamente un sandbox si es necesario!\n\nConsejo: Si ves errores de paquetes como \"react-router-dom no encontrado\", solo escribe \"npm install\" o \"revisar paquetes\" para instalar paquetes faltantes automáticamente.',
      type: 'system',
      timestamp: new Date()
    }
  ]);
